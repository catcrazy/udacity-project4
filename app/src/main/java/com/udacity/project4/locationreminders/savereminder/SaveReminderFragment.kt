...
//             2) save the reminder to the local db
            Log.i("savereminderfragment", "onclicklistener " + latitude)
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true, data: ReminderDataItem? = null) {
    ...
    private fun addGeofenceForReminder(data: ReminderDataItem) {
